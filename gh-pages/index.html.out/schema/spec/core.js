...
return (function (){
var G__20962 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__20962) : err_f.call(null,G__20962));
...
var G__20966 = s;
var G__20967 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$subschema_DASH_checker,f,cljs.core.cst$kw$return_DASH_walked_QMARK_,return_walked_QMARK_,cljs.core.cst$kw$cache,(function (){var G__20968 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__20968) : cljs.core.atom.call(null,G__20968));
})()], null);
...
var G__20970 = (new cljs.core.Delay(((function (w,temp__6736__auto__){
return (function (){
...
,null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__20970) : wrap_recursive_delay.call(null,G__20970));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__20971,p__20972){
var map__20977 = p__20971;
var map__20977__$1 = ((((!((map__20977 == null)))?((((map__20977.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20977.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20977):map__20977);
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20977__$1,cljs.core.cst$kw$schema);
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20977__$1,cljs.core.cst$kw$error_DASH_wrap);
var map__20978 = p__20972;
...
var params = map__20978__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20978__$1,cljs.core.cst$kw$subschema_DASH_checker);
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20978__$1,cljs.core.cst$kw$cache);
var sub = schema.spec.core.with_cache(cache,schema__$1,((function (map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache){
return (function (x){
...
;})(map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache))
});})(map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache))
,((function (map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache){
return (function (){
...
return ((function (sub,map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__20977,map__20977__$1,schema__$1,error_wrap,map__20978,map__20978__$1,params,subschema_checker,cache))
} else {
return sub;
}
});
