...
return (function (){
var G__21116 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__21116) : err_f.call(null,G__21116));
...
var G__21120 = s;
var G__21121 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$subschema_DASH_checker,f,cljs.core.cst$kw$return_DASH_walked_QMARK_,return_walked_QMARK_,cljs.core.cst$kw$cache,(function (){var G__21122 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__21122) : cljs.core.atom.call(null,G__21122));
})()], null);
...
var G__21124 = (new cljs.core.Delay(((function (w,temp__6736__auto__){
return (function (){
...
,null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__21124) : wrap_recursive_delay.call(null,G__21124));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__21125,p__21126){
var map__21131 = p__21125;
...
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21131__$1,cljs.core.cst$kw$schema);
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21131__$1,cljs.core.cst$kw$error_DASH_wrap);
var map__21132 = p__21126;
var map__21132__$1 = ((((!((map__21132 == null)))?((((map__21132.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21132.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21132):map__21132);
var params = map__21132__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21132__$1,cljs.core.cst$kw$subschema_DASH_checker);
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21132__$1,cljs.core.cst$kw$cache);
var sub = schema.spec.core.with_cache(cache,schema__$1,((function (map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache){
return (function (x){
...
;})(map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache))
});})(map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache))
,((function (map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache){
return (function (){
...
return ((function (sub,map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__21131,map__21131__$1,schema__$1,error_wrap,map__21132,map__21132__$1,params,subschema_checker,cache))
} else {
return sub;
}
});
