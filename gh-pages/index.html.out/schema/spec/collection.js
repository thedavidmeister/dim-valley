...
var G__20978 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__20978) {
case "schema.spec.collection/optional":
var G__20979 = cljs.core.next(e);
var G__20980 = params;
var G__20981 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__20979,G__20980,G__20981) : schema.spec.collection.sequence_transformer.call(null,G__20979,G__20980,G__20981));
...
return (function (res,x){
var G__20982 = res;
var G__20983 = (function (){var G__20984 = ((function (G__20982,parser,c){
return (function (t){
...
;
var G__20985 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__20984,G__20985) : parser.call(null,G__20984,G__20985));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__20982,G__20983) : then.call(null,G__20982,G__20983));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__20987_SHARP_){
return (cljs.core.vector_QMARK_(p1__20987_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__20987_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k20989,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k20989,else__8438__auto__);
...
var res = (function (){var G__20992 = cljs.core.PersistentVector.EMPTY;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20988){
var self__ = this;
var G__20988__$1 = this;
return (new cljs.core.RecordIter((0),G__20988__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__20988){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__20993 = cljs.core.keyword_identical_QMARK_;
var expr__20994 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__20996 = cljs.core.cst$kw$pre;
var G__20997 = expr__20994;
return (pred__20993.cljs$core$IFn$_invoke$arity$2 ? pred__20993.cljs$core$IFn$_invoke$arity$2(G__20996,G__20997) : pred__20993.call(null,G__20996,G__20997));
})())){
return (new schema.spec.collection.CollectionSpec(G__20988,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__20998 = cljs.core.cst$kw$constructor;
var G__20999 = expr__20994;
return (pred__20993.cljs$core$IFn$_invoke$arity$2 ? pred__20993.cljs$core$IFn$_invoke$arity$2(G__20998,G__20999) : pred__20993.call(null,G__20998,G__20999));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__20988,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21000 = cljs.core.cst$kw$elements;
var G__21001 = expr__20994;
return (pred__20993.cljs$core$IFn$_invoke$arity$2 ? pred__20993.cljs$core$IFn$_invoke$arity$2(G__21000,G__21001) : pred__20993.call(null,G__21000,G__21001));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__20988,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21002 = cljs.core.cst$kw$on_DASH_error;
var G__21003 = expr__20994;
return (pred__20993.cljs$core$IFn$_invoke$arity$2 ? pred__20993.cljs$core$IFn$_invoke$arity$2(G__21002,G__21003) : pred__20993.call(null,G__21002,G__21003));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__20988,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__20988),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__20988){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__20988,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__20990){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__20990),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__20990),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__20990),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__20990),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__20990,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___21006 = arguments.length;
var i__8982__auto___21007 = (0);
while(true){
if((i__8982__auto___21007 < len__8981__auto___21006)){
args__8988__auto__.push((arguments[i__8982__auto___21007]));

var G__21008 = (i__8982__auto___21007 + (1));
i__8982__auto___21007 = G__21008;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq21005){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21005));
});
