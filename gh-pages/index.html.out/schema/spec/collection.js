...
var G__16447 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__16447) {
case "schema.spec.collection/optional":
var G__16448 = cljs.core.next(e);
var G__16449 = params;
var G__16450 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__16448,G__16449,G__16450) : schema.spec.collection.sequence_transformer.call(null,G__16448,G__16449,G__16450));
...
return (function (res,x){
var G__16451 = res;
var G__16452 = (function (){var G__16453 = ((function (G__16451,parser,c){
return (function (t){
...
;
var G__16454 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__16453,G__16454) : parser.call(null,G__16453,G__16454));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__16451,G__16452) : then.call(null,G__16451,G__16452));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__16456_SHARP_){
return (cljs.core.vector_QMARK_(p1__16456_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__16456_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16458,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16460 = (((k16458 instanceof cljs.core.Keyword))?k16458.fqn:null);
switch (G__16460) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16458,else__8438__auto__);
...
var res = (function (){var G__16461 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16461) : cljs.core.atom.call(null,G__16461));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16457){
var self__ = this;
var G__16457__$1 = this;
return (new cljs.core.RecordIter((0),G__16457__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16457){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16462 = cljs.core.keyword_identical_QMARK_;
var expr__16463 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16465 = cljs.core.cst$kw$pre;
...
return (new schema.spec.collection.CollectionSpec(G__16457,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16467 = cljs.core.cst$kw$constructor;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,G__16457,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16469 = cljs.core.cst$kw$elements;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__16457,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16471 = cljs.core.cst$kw$on_DASH_error;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__16457,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16457),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16457){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__16457,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__16459){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16459),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__16459),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__16459),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__16459),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16459,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___16475 = arguments.length;
var i__8982__auto___16476 = (0);
while(true){
if((i__8982__auto___16476 < len__8981__auto___16475)){
args__8988__auto__.push((arguments[i__8982__auto___16476]));

var G__16477 = (i__8982__auto___16476 + (1));
i__8982__auto___16476 = G__16477;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq16474){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16474));
});
