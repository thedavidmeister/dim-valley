...
var G__21597 = cljs.core.first(e);
var G__21597__$1 = (((G__21597 instanceof cljs.core.Keyword))?G__21597.fqn:null);
switch (G__21597__$1) {
case "schema.spec.collection/optional":
var G__21598 = cljs.core.next(e);
var G__21599 = params;
var G__21600 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__21598,G__21599,G__21600) : schema.spec.collection.sequence_transformer.call(null,G__21598,G__21599,G__21600));
...
return ((function (_,c,G__21597,G__21597__$1){
...
return (function (res,x){
var G__21601 = res;
var G__21602 = (function (){var G__21603 = ((function (G__21601,parser,c){
return (function (t){
...
;
var G__21604 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__21603,G__21604) : parser.call(null,G__21603,G__21604));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__21601,G__21602) : then.call(null,G__21601,G__21602));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__21606_SHARP_){
return (cljs.core.vector_QMARK_(p1__21606_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__21606_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
if(cljs.core.truth_((function (){var G__21608 = cljs.core.first(elt);
var fexpr__21607 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$schema$spec$collection_SLASH_remaining,null,cljs.core.cst$kw$schema$spec$collection_SLASH_optional,null], null), null);
return (fexpr__21607.cljs$core$IFn$_invoke$arity$1 ? fexpr__21607.cljs$core$IFn$_invoke$arity$1(G__21608) : fexpr__21607.call(null,G__21608));
})())){
} else {
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8932__auto__,k21610,else__8933__auto__){
var self__ = this;
var this__8932__auto____$1 = this;
var G__21614 = k21610;
var G__21614__$1 = (((G__21614 instanceof cljs.core.Keyword))?G__21614.fqn:null);
switch (G__21614__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21610,else__8933__auto__);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21609){
var self__ = this;
var G__21609__$1 = this;
return (new cljs.core.RecordIter((0),G__21609__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__8698__auto____$1 = (function (){var fexpr__21615 = ((function (h__8698__auto__,this__8926__auto____$1){
...
;
return fexpr__21615(this__8926__auto____$1);
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21611,other21612){
var self__ = this;
var this21611__$1 = this;
return (!((other21612 == null))) && ((this21611__$1.constructor === other21612.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21611__$1.pre,other21612.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21611__$1.constructor,other21612.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21611__$1.elements,other21612.elements)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21611__$1.on_error,other21612.on_error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21611__$1.__extmap,other21612.__extmap));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8937__auto__,k__8938__auto__,G__21609){
var self__ = this;
var this__8937__auto____$1 = this;
var pred__21616 = cljs.core.keyword_identical_QMARK_;
var expr__21617 = k__8938__auto__;
if(cljs.core.truth_((function (){var G__21619 = cljs.core.cst$kw$pre;
...
return (new schema.spec.collection.CollectionSpec(G__21609,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21621 = cljs.core.cst$kw$constructor;
var G__21622 = expr__21617;
return (pred__21616.cljs$core$IFn$_invoke$arity$2 ? pred__21616.cljs$core$IFn$_invoke$arity$2(G__21621,G__21622) : pred__21616.call(null,G__21621,G__21622));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__21609,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21623 = cljs.core.cst$kw$elements;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__21609,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21625 = cljs.core.cst$kw$on_DASH_error;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__21609,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8938__auto__,G__21609),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8929__auto__,G__21609){
var self__ = this;
var this__8929__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__21609,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__21613){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21613),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__21613),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__21613),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__21613),null,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21613,cljs.core.cst$kw$pre,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0))),null));
});
...
var len__9519__auto___21629 = arguments.length;
var i__9520__auto___21630 = (0);
while(true){
if((i__9520__auto___21630 < len__9519__auto___21629)){
args__9526__auto__.push((arguments[i__9520__auto___21630]));

var G__21631 = (i__9520__auto___21630 + (1));
i__9520__auto___21630 = G__21631;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq21628){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21628));
});
