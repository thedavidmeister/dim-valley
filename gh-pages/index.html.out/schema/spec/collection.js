...
var G__20995 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__20995) {
case "schema.spec.collection/optional":
var G__20996 = cljs.core.next(e);
var G__20997 = params;
var G__20998 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__20996,G__20997,G__20998) : schema.spec.collection.sequence_transformer.call(null,G__20996,G__20997,G__20998));
...
return (function (res,x){
var G__20999 = res;
var G__21000 = (function (){var G__21001 = ((function (G__20999,parser,c){
return (function (t){
...
;
var G__21002 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__21001,G__21002) : parser.call(null,G__21001,G__21002));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__20999,G__21000) : then.call(null,G__20999,G__21000));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__21004_SHARP_){
return (cljs.core.vector_QMARK_(p1__21004_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__21004_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21006,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__21008 = (((k21006 instanceof cljs.core.Keyword))?k21006.fqn:null);
switch (G__21008) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21006,else__8438__auto__);
...
var res = (function (){var G__21009 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__21009) : cljs.core.atom.call(null,G__21009));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21005){
var self__ = this;
var G__21005__$1 = this;
return (new cljs.core.RecordIter((0),G__21005__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21005){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21010 = cljs.core.keyword_identical_QMARK_;
var expr__21011 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21013 = cljs.core.cst$kw$pre;
...
return (new schema.spec.collection.CollectionSpec(G__21005,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21015 = cljs.core.cst$kw$constructor;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,G__21005,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21017 = cljs.core.cst$kw$elements;
var G__21018 = expr__21011;
return (pred__21010.cljs$core$IFn$_invoke$arity$2 ? pred__21010.cljs$core$IFn$_invoke$arity$2(G__21017,G__21018) : pred__21010.call(null,G__21017,G__21018));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__21005,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21019 = cljs.core.cst$kw$on_DASH_error;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__21005,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21005),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21005){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__21005,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__21007){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21007),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__21007),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__21007),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__21007),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21007,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___21023 = arguments.length;
var i__8982__auto___21024 = (0);
while(true){
if((i__8982__auto___21024 < len__8981__auto___21023)){
args__8988__auto__.push((arguments[i__8982__auto___21024]));

var G__21025 = (i__8982__auto___21024 + (1));
i__8982__auto___21024 = G__21025;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq21022){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21022));
});
