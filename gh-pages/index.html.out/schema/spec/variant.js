...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21164,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21164,else__8438__auto__);
...
return (function (){
var G__21167 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21167) : self__.err_f.call(null,G__21167));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__21169 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21169) : self__.post.call(null,G__21169));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21163){
var self__ = this;
var G__21163__$1 = this;
return (new cljs.core.RecordIter((0),G__21163__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21163){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21170 = cljs.core.keyword_identical_QMARK_;
var expr__21171 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21173 = cljs.core.cst$kw$pre;
var G__21174 = expr__21171;
return (pred__21170.cljs$core$IFn$_invoke$arity$2 ? pred__21170.cljs$core$IFn$_invoke$arity$2(G__21173,G__21174) : pred__21170.call(null,G__21173,G__21174));
})())){
return (new schema.spec.variant.VariantSpec(G__21163,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21175 = cljs.core.cst$kw$options;
var G__21176 = expr__21171;
return (pred__21170.cljs$core$IFn$_invoke$arity$2 ? pred__21170.cljs$core$IFn$_invoke$arity$2(G__21175,G__21176) : pred__21170.call(null,G__21175,G__21176));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__21163,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21177 = cljs.core.cst$kw$err_DASH_f;
var G__21178 = expr__21171;
return (pred__21170.cljs$core$IFn$_invoke$arity$2 ? pred__21170.cljs$core$IFn$_invoke$arity$2(G__21177,G__21178) : pred__21170.call(null,G__21177,G__21178));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21163,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21179 = cljs.core.cst$kw$post;
var G__21180 = expr__21171;
return (pred__21170.cljs$core$IFn$_invoke$arity$2 ? pred__21170.cljs$core$IFn$_invoke$arity$2(G__21179,G__21180) : pred__21170.call(null,G__21179,G__21180));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21163,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21163),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21163){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21163,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21165){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21165),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21165),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21165),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21165),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21165,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args21182 = [];
var len__8981__auto___21185 = arguments.length;
var i__8982__auto___21186 = (0);
while(true){
if((i__8982__auto___21186 < len__8981__auto___21185)){
args21182.push((arguments[i__8982__auto___21186]));

var G__21187 = (i__8982__auto___21186 + (1));
i__8982__auto___21186 = G__21187;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args21182.length)].join('')));
