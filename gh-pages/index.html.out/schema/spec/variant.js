...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21368,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__21370 = (((k21368 instanceof cljs.core.Keyword))?k21368.fqn:null);
switch (G__21370) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21368,else__8438__auto__);
...
return (function (){
var G__21371 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21371) : self__.err_f.call(null,G__21371));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__21373 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21373) : self__.post.call(null,G__21373));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21367){
var self__ = this;
var G__21367__$1 = this;
return (new cljs.core.RecordIter((0),G__21367__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21367){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21374 = cljs.core.keyword_identical_QMARK_;
var expr__21375 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21377 = cljs.core.cst$kw$pre;
var G__21378 = expr__21375;
return (pred__21374.cljs$core$IFn$_invoke$arity$2 ? pred__21374.cljs$core$IFn$_invoke$arity$2(G__21377,G__21378) : pred__21374.call(null,G__21377,G__21378));
})())){
return (new schema.spec.variant.VariantSpec(G__21367,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21379 = cljs.core.cst$kw$options;
var G__21380 = expr__21375;
return (pred__21374.cljs$core$IFn$_invoke$arity$2 ? pred__21374.cljs$core$IFn$_invoke$arity$2(G__21379,G__21380) : pred__21374.call(null,G__21379,G__21380));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__21367,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21381 = cljs.core.cst$kw$err_DASH_f;
var G__21382 = expr__21375;
return (pred__21374.cljs$core$IFn$_invoke$arity$2 ? pred__21374.cljs$core$IFn$_invoke$arity$2(G__21381,G__21382) : pred__21374.call(null,G__21381,G__21382));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21367,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21383 = cljs.core.cst$kw$post;
var G__21384 = expr__21375;
return (pred__21374.cljs$core$IFn$_invoke$arity$2 ? pred__21374.cljs$core$IFn$_invoke$arity$2(G__21383,G__21384) : pred__21374.call(null,G__21383,G__21384));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21367,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21367),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21367){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21367,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21369){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21369),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21369),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21369),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21369),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21369,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
args21386.push((arguments[i__8982__auto___21390]));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args21386.length)].join('')));
