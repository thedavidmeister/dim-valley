...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16483,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16485 = (((k16483 instanceof cljs.core.Keyword))?k16483.fqn:null);
switch (G__16485) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16483,else__8438__auto__);
...
return (function (){
var G__16486 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__16486) : self__.err_f.call(null,G__16486));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__16488 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__16488) : self__.post.call(null,G__16488));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16482){
var self__ = this;
var G__16482__$1 = this;
return (new cljs.core.RecordIter((0),G__16482__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16482){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16489 = cljs.core.keyword_identical_QMARK_;
var expr__16490 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16492 = cljs.core.cst$kw$pre;
var G__16493 = expr__16490;
return (pred__16489.cljs$core$IFn$_invoke$arity$2 ? pred__16489.cljs$core$IFn$_invoke$arity$2(G__16492,G__16493) : pred__16489.call(null,G__16492,G__16493));
})())){
return (new schema.spec.variant.VariantSpec(G__16482,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16494 = cljs.core.cst$kw$options;
var G__16495 = expr__16490;
return (pred__16489.cljs$core$IFn$_invoke$arity$2 ? pred__16489.cljs$core$IFn$_invoke$arity$2(G__16494,G__16495) : pred__16489.call(null,G__16494,G__16495));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__16482,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16496 = cljs.core.cst$kw$err_DASH_f;
var G__16497 = expr__16490;
return (pred__16489.cljs$core$IFn$_invoke$arity$2 ? pred__16489.cljs$core$IFn$_invoke$arity$2(G__16496,G__16497) : pred__16489.call(null,G__16496,G__16497));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__16482,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16498 = cljs.core.cst$kw$post;
var G__16499 = expr__16490;
return (pred__16489.cljs$core$IFn$_invoke$arity$2 ? pred__16489.cljs$core$IFn$_invoke$arity$2(G__16498,G__16499) : pred__16489.call(null,G__16498,G__16499));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__16482,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16482),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16482){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__16482,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__16484){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16484),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__16484),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__16484),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__16484),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16484,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args16501 = [];
var len__8981__auto___16504 = arguments.length;
var i__8982__auto___16505 = (0);
while(true){
if((i__8982__auto___16505 < len__8981__auto___16504)){
args16501.push((arguments[i__8982__auto___16505]));

var G__16506 = (i__8982__auto___16505 + (1));
i__8982__auto___16505 = G__16506;
continue;
} else {
}
break;
