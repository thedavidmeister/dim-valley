...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8932__auto__,k21603,else__8933__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21603,else__8933__auto__);
...
return (function (){
var G__21608 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21608) : self__.err_f.call(null,G__21608));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__8242__auto____$1 = (function (){var G__21610 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21610) : self__.post.call(null,G__21610));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21602){
var self__ = this;
var G__21602__$1 = this;
return (new cljs.core.RecordIter((0),G__21602__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__8698__auto____$1 = (function (){var fexpr__21611 = ((function (h__8698__auto__,this__8926__auto____$1){
...
;
return fexpr__21611(this__8926__auto____$1);
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21604,other21605){
var self__ = this;
var this21604__$1 = this;
return (!((other21605 == null))) && ((this21604__$1.constructor === other21605.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21604__$1.pre,other21605.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21604__$1.options,other21605.options)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21604__$1.err_f,other21605.err_f)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21604__$1.post,other21605.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21604__$1.__extmap,other21605.__extmap));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8937__auto__,k__8938__auto__,G__21602){
var self__ = this;
var this__8937__auto____$1 = this;
var pred__21612 = cljs.core.keyword_identical_QMARK_;
var expr__21613 = k__8938__auto__;
if(cljs.core.truth_((function (){var G__21615 = cljs.core.cst$kw$pre;
...
return (new schema.spec.variant.VariantSpec(G__21602,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21617 = cljs.core.cst$kw$options;
...
return (new schema.spec.variant.VariantSpec(self__.pre,G__21602,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21619 = cljs.core.cst$kw$err_DASH_f;
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21602,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21621 = cljs.core.cst$kw$post;
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21602,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8938__auto__,G__21602),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8929__auto__,G__21602){
var self__ = this;
var this__8929__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21602,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21606){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21606),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21606),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21606),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21606),null,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21606,cljs.core.cst$kw$pre,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0))),null));
});
