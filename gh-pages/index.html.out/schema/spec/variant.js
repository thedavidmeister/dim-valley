...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16495,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16497 = (((k16495 instanceof cljs.core.Keyword))?k16495.fqn:null);
switch (G__16497) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16495,else__8438__auto__);
...
return (function (){
var G__16498 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__16498) : self__.err_f.call(null,G__16498));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__16500 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__16500) : self__.post.call(null,G__16500));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16494){
var self__ = this;
var G__16494__$1 = this;
return (new cljs.core.RecordIter((0),G__16494__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16494){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16501 = cljs.core.keyword_identical_QMARK_;
var expr__16502 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16504 = cljs.core.cst$kw$pre;
var G__16505 = expr__16502;
return (pred__16501.cljs$core$IFn$_invoke$arity$2 ? pred__16501.cljs$core$IFn$_invoke$arity$2(G__16504,G__16505) : pred__16501.call(null,G__16504,G__16505));
})())){
return (new schema.spec.variant.VariantSpec(G__16494,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16506 = cljs.core.cst$kw$options;
var G__16507 = expr__16502;
return (pred__16501.cljs$core$IFn$_invoke$arity$2 ? pred__16501.cljs$core$IFn$_invoke$arity$2(G__16506,G__16507) : pred__16501.call(null,G__16506,G__16507));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__16494,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16508 = cljs.core.cst$kw$err_DASH_f;
var G__16509 = expr__16502;
return (pred__16501.cljs$core$IFn$_invoke$arity$2 ? pred__16501.cljs$core$IFn$_invoke$arity$2(G__16508,G__16509) : pred__16501.call(null,G__16508,G__16509));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__16494,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16510 = cljs.core.cst$kw$post;
var G__16511 = expr__16502;
return (pred__16501.cljs$core$IFn$_invoke$arity$2 ? pred__16501.cljs$core$IFn$_invoke$arity$2(G__16510,G__16511) : pred__16501.call(null,G__16510,G__16511));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__16494,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16494),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16494){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__16494,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__16496){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16496),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__16496),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__16496),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__16496),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16496,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args16513 = [];
var len__8981__auto___16516 = arguments.length;
var i__8982__auto___16517 = (0);
while(true){
if((i__8982__auto___16517 < len__8981__auto___16516)){
args16513.push((arguments[i__8982__auto___16517]));

var G__16518 = (i__8982__auto___16517 + (1));
i__8982__auto___16517 = G__16518;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args16513.length)].join('')));
