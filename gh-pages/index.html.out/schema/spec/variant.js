...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21027,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__21029 = (((k21027 instanceof cljs.core.Keyword))?k21027.fqn:null);
switch (G__21029) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21027,else__8438__auto__);
...
return (function (){
var G__21030 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21030) : self__.err_f.call(null,G__21030));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__21032 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21032) : self__.post.call(null,G__21032));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21026){
var self__ = this;
var G__21026__$1 = this;
return (new cljs.core.RecordIter((0),G__21026__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21026){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21033 = cljs.core.keyword_identical_QMARK_;
var expr__21034 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21036 = cljs.core.cst$kw$pre;
var G__21037 = expr__21034;
return (pred__21033.cljs$core$IFn$_invoke$arity$2 ? pred__21033.cljs$core$IFn$_invoke$arity$2(G__21036,G__21037) : pred__21033.call(null,G__21036,G__21037));
})())){
return (new schema.spec.variant.VariantSpec(G__21026,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21038 = cljs.core.cst$kw$options;
var G__21039 = expr__21034;
return (pred__21033.cljs$core$IFn$_invoke$arity$2 ? pred__21033.cljs$core$IFn$_invoke$arity$2(G__21038,G__21039) : pred__21033.call(null,G__21038,G__21039));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__21026,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21040 = cljs.core.cst$kw$err_DASH_f;
var G__21041 = expr__21034;
return (pred__21033.cljs$core$IFn$_invoke$arity$2 ? pred__21033.cljs$core$IFn$_invoke$arity$2(G__21040,G__21041) : pred__21033.call(null,G__21040,G__21041));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21026,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21042 = cljs.core.cst$kw$post;
var G__21043 = expr__21034;
return (pred__21033.cljs$core$IFn$_invoke$arity$2 ? pred__21033.cljs$core$IFn$_invoke$arity$2(G__21042,G__21043) : pred__21033.call(null,G__21042,G__21043));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21026,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21026),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21026){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21026,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21028){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21028),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21028),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21028),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21028),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21028,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args21045 = [];
var len__8981__auto___21048 = arguments.length;
var i__8982__auto___21049 = (0);
while(true){
if((i__8982__auto___21049 < len__8981__auto___21048)){
args21045.push((arguments[i__8982__auto___21049]));

var G__21050 = (i__8982__auto___21049 + (1));
i__8982__auto___21049 = G__21050;
continue;
} else {
}
break;
