...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21014,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__21016 = (((k21014 instanceof cljs.core.Keyword))?k21014.fqn:null);
switch (G__21016) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21014,else__8438__auto__);
...
return (function (){
var G__21017 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21017) : self__.err_f.call(null,G__21017));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__21019 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21019) : self__.post.call(null,G__21019));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21013){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21013){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21020 = cljs.core.keyword_identical_QMARK_;
var expr__21021 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21023 = cljs.core.cst$kw$pre;
var G__21024 = expr__21021;
return (pred__21020.cljs$core$IFn$_invoke$arity$2 ? pred__21020.cljs$core$IFn$_invoke$arity$2(G__21023,G__21024) : pred__21020.call(null,G__21023,G__21024));
})())){
return (new schema.spec.variant.VariantSpec(G__21013,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21025 = cljs.core.cst$kw$options;
var G__21026 = expr__21021;
return (pred__21020.cljs$core$IFn$_invoke$arity$2 ? pred__21020.cljs$core$IFn$_invoke$arity$2(G__21025,G__21026) : pred__21020.call(null,G__21025,G__21026));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__21013,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21027 = cljs.core.cst$kw$err_DASH_f;
var G__21028 = expr__21021;
return (pred__21020.cljs$core$IFn$_invoke$arity$2 ? pred__21020.cljs$core$IFn$_invoke$arity$2(G__21027,G__21028) : pred__21020.call(null,G__21027,G__21028));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21013,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21029 = cljs.core.cst$kw$post;
var G__21030 = expr__21021;
return (pred__21020.cljs$core$IFn$_invoke$arity$2 ? pred__21020.cljs$core$IFn$_invoke$arity$2(G__21029,G__21030) : pred__21020.call(null,G__21029,G__21030));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21013,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21013),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21013){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21013,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21015){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21015),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21015),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21015),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21015),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21015,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args21032 = [];
var len__8981__auto___21035 = arguments.length;
var i__8982__auto___21036 = (0);
while(true){
if((i__8982__auto___21036 < len__8981__auto___21035)){
args21032.push((arguments[i__8982__auto___21036]));

var G__21037 = (i__8982__auto___21036 + (1));
i__8982__auto___21036 = G__21037;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args21032.length)].join('')));
