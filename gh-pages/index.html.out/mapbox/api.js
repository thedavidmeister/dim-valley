...
var args24177 = [];
var len__8981__auto___24184 = arguments.length;
var i__8982__auto___24185 = (0);
while(true){
if((i__8982__auto___24185 < len__8981__auto___24184)){
args24177.push((arguments[i__8982__auto___24185]));

var G__24186 = (i__8982__auto___24185 + (1));
i__8982__auto___24185 = G__24186;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args24177.length)].join('')));

}
});

mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__24180){
var vec__24181 = p__24180;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24181,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24181,(1),null);
...
var G__24189 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__24189.setLngLat(ll);

G__24189.addTo(mapbox.api.map_el__GT_map(map_el));
