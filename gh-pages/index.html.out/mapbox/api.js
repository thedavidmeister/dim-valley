...
mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__25227){
var vec__25228 = p__25227;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25228,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25228,(1),null);
...
var G__25232 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__25232.setLngLat(ll);

G__25232.addTo(mapbox.api.map_el__GT_map(map_el));
