...
mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__25325){
var vec__25326 = p__25325;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25326,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25326,(1),null);
...
var G__25330 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__25330.setLngLat(ll);

G__25330.addTo(mapbox.api.map_el__GT_map(map_el));
