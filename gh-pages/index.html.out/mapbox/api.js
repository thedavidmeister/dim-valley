...
args24532.push((arguments[i__8982__auto___24540]));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args24532.length)].join('')));

}
});

mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__24535){
var vec__24536 = p__24535;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24536,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24536,(1),null);
...
var G__24544 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__24544.setLngLat(ll);

G__24544.addTo(mapbox.api.map_el__GT_map(map_el));
