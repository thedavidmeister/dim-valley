...
var args24194 = [];
var len__8981__auto___24201 = arguments.length;
var i__8982__auto___24202 = (0);
while(true){
if((i__8982__auto___24202 < len__8981__auto___24201)){
args24194.push((arguments[i__8982__auto___24202]));

var G__24203 = (i__8982__auto___24202 + (1));
i__8982__auto___24202 = G__24203;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args24194.length)].join('')));

}
});

mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__24197){
var vec__24198 = p__24197;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24198,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24198,(1),null);
...
var G__24206 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__24206.setLngLat(ll);

G__24206.addTo(mapbox.api.map_el__GT_map(map_el));
