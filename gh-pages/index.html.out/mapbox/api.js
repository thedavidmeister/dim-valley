...
var args24365 = [];
var len__8981__auto___24372 = arguments.length;
var i__8982__auto___24373 = (0);
while(true){
if((i__8982__auto___24373 < len__8981__auto___24372)){
args24365.push((arguments[i__8982__auto___24373]));

var G__24374 = (i__8982__auto___24373 + (1));
i__8982__auto___24373 = G__24374;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args24365.length)].join('')));

}
});

mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__24368){
var vec__24369 = p__24368;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24369,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24369,(1),null);
...
var G__24377 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__24377.setLngLat(ll);

G__24377.addTo(mapbox.api.map_el__GT_map(map_el));
