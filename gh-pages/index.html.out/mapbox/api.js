...
var args24319 = [];
var len__8981__auto___24326 = arguments.length;
var i__8982__auto___24327 = (0);
while(true){
if((i__8982__auto___24327 < len__8981__auto___24326)){
args24319.push((arguments[i__8982__auto___24327]));

var G__24328 = (i__8982__auto___24327 + (1));
i__8982__auto___24327 = G__24328;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args24319.length)].join('')));

}
});

mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__24322){
var vec__24323 = p__24322;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24323,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24323,(1),null);
...
var G__24331 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__24331.setLngLat(ll);

G__24331.addTo(mapbox.api.map_el__GT_map(map_el));
