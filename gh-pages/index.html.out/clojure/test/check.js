...
var len__9915__auto___18059 = arguments.length;
var i__9916__auto___18060 = (0);
while(true){
if((i__9916__auto___18060 < len__9915__auto___18059)){
args__9922__auto__.push((arguments[i__9916__auto___18060]));

var G__18061 = (i__9916__auto___18060 + (1));
i__9916__auto___18060 = G__18061;
continue;
} else {
}
break;
...
return clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9923__auto__);
});

clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__18047){
...
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18048__$1,cljs.core.cst$kw$seed);
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18048__$1,cljs.core.cst$kw$max_DASH_size,(200));
var vec__18050 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18050,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18050,(1),null);
...
var size = first__18055;
var rest_size_seq = seq__18054__$1;
var vec__18056 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18056,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18056,(1),null);
...
var G__18062 = (so_far + (1));
var G__18063 = rest_size_seq;
var G__18064 = r2;
so_far = G__18062;
size_seq__$1 = G__18063;
rstate = G__18064;
continue;
} else {
...
clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq18044){
...
return clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic(G__18045,G__18046,seq18044__$2);
});
...
var vec__18065 = nodes;
var seq__18066 = cljs.core.seq(vec__18065);
var first__18067 = cljs.core.first(seq__18066);
var seq__18066__$1 = cljs.core.next(seq__18066);
var head = first__18067;
var tail = seq__18066__$1;
var result = cljs.core.cst$kw$result.cljs$core$IFn$_invoke$arity$1(clojure.test.check.rose_tree.root(head));
if(cljs.core.truth_(clojure.test.check.not_falsey_or_exception_QMARK_(result))){
var G__18068 = tail;
var G__18069 = current_smallest;
var G__18070 = (total_nodes_visited + (1));
var G__18071 = depth;
nodes = G__18068;
current_smallest = G__18069;
total_nodes_visited = G__18070;
depth = G__18071;
continue;
} else {
...
var G__18072 = children;
var G__18073 = clojure.test.check.rose_tree.root(head);
var G__18074 = (total_nodes_visited + (1));
var G__18075 = (depth + (1));
nodes = G__18072;
current_smallest = G__18073;
total_nodes_visited = G__18074;
depth = G__18075;
continue;
} else {
var G__18076 = tail;
var G__18077 = clojure.test.check.rose_tree.root(head);
var G__18078 = (total_nodes_visited + (1));
var G__18079 = depth;
nodes = G__18076;
current_smallest = G__18077;
total_nodes_visited = G__18078;
depth = G__18079;
continue;
}
}
