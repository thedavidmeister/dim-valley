...
oops.messages.runtime_message = (function (){var method_table__9293__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("oops.messages","runtime-message"),((function (method_table__9293__auto__,prefer_table__9294__auto__,method_cache__9295__auto__,cached_hierarchy__9296__auto__,hierarchy__9297__auto__){
return (function() { 
<<<<<<< HEAD
var G__20218__delegate = function (type,_){
return type;
};
var G__20218 = function (type,var_args){
var _ = null;
...
while (G__20219__i < G__20219__a.length) {G__20219__a[G__20219__i] = arguments[G__20219__i + 1]; ++G__20219__i;}
  _ = new cljs.core.IndexedSeq(G__20219__a,0,null);
} 
return G__20218__delegate.call(this,type,_);};
G__20218.cljs$lang$maxFixedArity = 1;
G__20218.cljs$lang$applyTo = (function (arglist__20220){
var type = cljs.core.first(arglist__20220);
var _ = cljs.core.rest(arglist__20220);
return G__20218__delegate(type,_);
});
G__20218.cljs$core$IFn$_invoke$arity$variadic = G__20218__delegate;
return G__20218;
=======
var G__20630__delegate = function (type,_){
return type;
};
var G__20630 = function (type,var_args){
var _ = null;
if (arguments.length > 1) {
var G__20631__i = 0, G__20631__a = new Array(arguments.length -  1);
while (G__20631__i < G__20631__a.length) {G__20631__a[G__20631__i] = arguments[G__20631__i + 1]; ++G__20631__i;}
  _ = new cljs.core.IndexedSeq(G__20631__a,0,null);
} 
return G__20630__delegate.call(this,type,_);};
G__20630.cljs$lang$maxFixedArity = 1;
G__20630.cljs$lang$applyTo = (function (arglist__20632){
var type = cljs.core.first(arglist__20632);
var _ = cljs.core.rest(arglist__20632);
return G__20630__delegate(type,_);
});
...
<<<<<<< HEAD
var map__20221 = info;
var map__20221__$1 = ((((!((map__20221 == null)))?((((map__20221.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20221.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20221):map__20221);
var flavor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20221__$1,cljs.core.cst$kw$flavor);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20221__$1,cljs.core.cst$kw$path);
...
var soft_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20223__$1,cljs.core.cst$kw$soft_QMARK_);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20223__$1,cljs.core.cst$kw$path);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20223__$1,cljs.core.cst$kw$fn);
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20225__$1,cljs.core.cst$kw$key);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20225__$1,cljs.core.cst$kw$path);
=======
var map__20633 = info;
var map__20633__$1 = ((((!((map__20633 == null)))?((((map__20633.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20633.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20633):map__20633);
var flavor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20633__$1,cljs.core.cst$kw$flavor);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20633__$1,cljs.core.cst$kw$path);
return (oops.messages.post_process_message.cljs$core$IFn$_invoke$arity$1 ? oops.messages.post_process_message.cljs$core$IFn$_invoke$arity$1(["Unexpected object value (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(flavor),")",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_(path)))?[" on key path '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"'"].join(''):null))].join('')) : oops.messages.post_process_message.call(null,["Unexpected object value (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(flavor),")",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_(path)))?[" on key path '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"'"].join(''):null))].join('')));
}));
oops.messages.runtime_message.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$expected_DASH_function_DASH_value,(function (_type,info){
var map__20635 = info;
...
var soft_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20635__$1,cljs.core.cst$kw$soft_QMARK_);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20635__$1,cljs.core.cst$kw$path);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20635__$1,cljs.core.cst$kw$fn);
return (oops.messages.post_process_message.cljs$core$IFn$_invoke$arity$1 ? oops.messages.post_process_message.cljs$core$IFn$_invoke$arity$1(["Expected a function",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(soft_QMARK_)?[" or nil"].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_(path)))?[" on key path '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"'"].join(''):null)),", got <",cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.typeOf(fn)),"> instead"].join('')) : oops.messages.post_process_message.call(null,["Expected a function",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(soft_QMARK_)?[" or nil"].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_(path)))?[" on key path '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"'"].join(''):null)),", got <",cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.typeOf(fn)),"> instead"].join('')));
}));
oops.messages.runtime_message.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$missing_DASH_object_DASH_key,(function (_type,info){
var map__20637 = info;
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20637__$1,cljs.core.cst$kw$key);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20637__$1,cljs.core.cst$kw$path);
>>>>>>> 84b1f3c9136f6022950f77a8e7c9302fda7c28c0
