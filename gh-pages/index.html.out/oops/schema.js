...
var G__20228 = cljs.core.first(element_str);
switch (G__20228) {
case "?":
arr.push((1));
...
var G__20230 = cljs.core.next(items);
items = G__20230;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__20233 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__20233) : is_valid_QMARK_.call(null,G__20233));
})())){
var G__20234 = cljs.core.next(cljs.core.next(items));
items = G__20234;
continue;
} else {
return true;
...
switch (G__20237) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__20237){
return (function (p1__20235_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20235_SHARP_,(2));
});})(G__20237))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20236_SHARP_,(1));
});})(G__20237))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20237)].join('')));
