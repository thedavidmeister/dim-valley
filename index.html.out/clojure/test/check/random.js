...
var x__8973__auto__ = (((rng == null))?null:rng);
var m__8974__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__8973__auto__)]);
if(!((m__8974__auto__ == null))){
return (m__8974__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto__.call(null,rng));
} else {
var m__8974__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__8974__auto____$1 == null))){
return (m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto____$1.call(null,rng));
} else {
...
var x__8973__auto__ = (((rng == null))?null:rng);
var m__8974__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__8973__auto__)]);
if(!((m__8974__auto__ == null))){
return (m__8974__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto__.call(null,rng));
} else {
var m__8974__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__8974__auto____$1 == null))){
return (m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto____$1.call(null,rng));
} else {
...
var x__8973__auto__ = (((rng == null))?null:rng);
var m__8974__auto__ = (clojure.test.check.random.split[goog.typeOf(x__8973__auto__)]);
if(!((m__8974__auto__ == null))){
return (m__8974__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto__.call(null,rng));
} else {
var m__8974__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__8974__auto____$1 == null))){
return (m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8974__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8974__auto____$1.call(null,rng));
} else {
...
var x__8973__auto__ = (((rng == null))?null:rng);
var m__8974__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__8973__auto__)]);
if(!((m__8974__auto__ == null))){
return (m__8974__auto__.cljs$core$IFn$_invoke$arity$2 ? m__8974__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8974__auto__.call(null,rng,n));
} else {
var m__8974__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__8974__auto____$1 == null))){
return (m__8974__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__8974__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8974__auto____$1.call(null,rng,n));
} else {
...
<<<<<<< HEAD
var G__15761 = z;
if(((24) > (function (){var G__15762 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__15762) : clojure.test.check.random.longs.bit_count.call(null,G__15762));
})())){
return clojure.test.check.random.longs.bit_xor(G__15761,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15761;
=======
var G__16925 = z;
if(((24) > (function (){var G__16926 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16926) : clojure.test.check.random.longs.bit_count.call(null,G__16926));
})())){
return clojure.test.check.random.longs.bit_xor(G__16925,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16925;
...
<<<<<<< HEAD
var G__15765 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15766 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__15765;
ret = G__15766;
=======
var G__16929 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16930 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16929;
ret = G__16930;
>>>>>>> 84b1f3c9136f6022950f77a8e7c9302fda7c28c0
continue;
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8911__auto__,writer__8912__auto__,opt__8913__auto__){
return cljs.core._write(writer__8912__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8240__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15768__$1,cljs.core.cst$kw$state);
var vec__15770 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15770,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15770,(1),null);
=======
return (function (p__16931){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16932__$1,cljs.core.cst$kw$state);
var vec__16934 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16934,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16934,(1),null);
>>>>>>> 84b1f3c9136f6022950f77a8e7c9302fda7c28c0
