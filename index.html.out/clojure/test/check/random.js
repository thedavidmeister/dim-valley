...
var x__8975__auto__ = (((rng == null))?null:rng);
var m__8976__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__8975__auto__)]);
if(!((m__8976__auto__ == null))){
return (m__8976__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto__.call(null,rng));
} else {
var m__8976__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__8976__auto____$1 == null))){
return (m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto____$1.call(null,rng));
} else {
...
var x__8975__auto__ = (((rng == null))?null:rng);
var m__8976__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__8975__auto__)]);
if(!((m__8976__auto__ == null))){
return (m__8976__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto__.call(null,rng));
} else {
var m__8976__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__8976__auto____$1 == null))){
return (m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto____$1.call(null,rng));
} else {
...
var x__8975__auto__ = (((rng == null))?null:rng);
var m__8976__auto__ = (clojure.test.check.random.split[goog.typeOf(x__8975__auto__)]);
if(!((m__8976__auto__ == null))){
return (m__8976__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto__.call(null,rng));
} else {
var m__8976__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__8976__auto____$1 == null))){
return (m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8976__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8976__auto____$1.call(null,rng));
} else {
...
var x__8975__auto__ = (((rng == null))?null:rng);
var m__8976__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__8975__auto__)]);
if(!((m__8976__auto__ == null))){
return (m__8976__auto__.cljs$core$IFn$_invoke$arity$2 ? m__8976__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8976__auto__.call(null,rng,n));
} else {
var m__8976__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__8976__auto____$1 == null))){
return (m__8976__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__8976__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8976__auto____$1.call(null,rng,n));
} else {
...
var G__15763 = z;
if(((24) > (function (){var G__15764 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__15764) : clojure.test.check.random.longs.bit_count.call(null,G__15764));
})())){
return clojure.test.check.random.longs.bit_xor(G__15763,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15763;
}
});
...
var G__15767 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15768 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__15767;
ret = G__15768;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8913__auto__,writer__8914__auto__,opt__8915__auto__){
return cljs.core._write(writer__8914__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8242__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15770__$1,cljs.core.cst$kw$state);
var vec__15772 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15772,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15772,(1),null);
