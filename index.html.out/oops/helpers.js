...
var and__8626__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__8626__auto__)){
var and__8626__auto____$1 = cljs.core.not(oops.helpers.is_prototype_QMARK_(f));
...
var and__8626__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__8626__auto__)){
...
var G__23363 = cljs.core.next(items);
items = G__23363;
continue;
} else {
return arr;
...
var x23364 = error;
x23364.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x23364.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x23364){
