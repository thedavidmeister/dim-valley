...
var G__24180 = cljs.core.first(element_str);
switch (G__24180) {
case "?":
arr.push((1));
...
var G__24182 = cljs.core.next(items);
items = G__24182;
continue;
} else {
return null;
...
var G__24183 = cljs.core.next(items);
items = G__24183;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__24185 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__24185) : is_valid_QMARK_.call(null,G__24185));
})())){
var G__24186 = cljs.core.next(cljs.core.next(items));
items = G__24186;
continue;
} else {
return true;
...
switch (G__24189) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__24189){
return (function (p1__24187_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24187_SHARP_,(2));
});})(G__24189))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24188_SHARP_,(1));
});})(G__24189))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24189)].join('')));
