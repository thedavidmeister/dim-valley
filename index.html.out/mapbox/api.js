...
mapbox.api.lng_lat.cljs$core$IFn$_invoke$arity$1 = (function (p__25236){
var vec__25237 = p__25236;
var lng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25237,(0),null);
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25237,(1),null);
...
var G__25241 = (new mapboxgl.Marker(marker_el,cljs.core.clj__GT_js(marker_options)));
G__25241.setLngLat(ll);

G__25241.addTo(mapbox.api.map_el__GT_map(map_el));
