...
hoplon.spec.do_BANG_ = (function (){var method_table__9691__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__9695__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$default,cljs.core.cst$kw$hoplon$spec_SLASH_default], null),cljs.core.cst$kw$hierarchy,cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("hoplon.spec","do!"),((function (method_table__9691__auto__,prefer_table__9692__auto__,method_cache__9693__auto__,cached_hierarchy__9694__auto__,hierarchy__9695__auto__){
return (function (p__15446){
var vec__15447 = p__15446;
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15447,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15447,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15447,(2),null);
...
,cljs.core.cst$kw$hoplon$spec_SLASH_default,hierarchy__9695__auto__,method_table__9691__auto__,prefer_table__9692__auto__,method_cache__9693__auto__,cached_hierarchy__9694__auto__));
})();
}
...
hoplon.spec.on_BANG_ = (function (){var method_table__9691__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__9692__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__9693__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__9694__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__9695__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$default,cljs.core.cst$kw$hoplon$spec_SLASH_default], null),cljs.core.cst$kw$hierarchy,cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("hoplon.spec","on!"),((function (method_table__9691__auto__,prefer_table__9692__auto__,method_cache__9693__auto__,cached_hierarchy__9694__auto__,hierarchy__9695__auto__){
return (function (p__15450){
var vec__15451 = p__15450;
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15451,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15451,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15451,(2),null);
var temp__5288__auto__ = cljs.core.namespace(key);
if(cljs.core.truth_(temp__5288__auto__)){
var n = temp__5288__auto__;
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(n,"*");
...
cljs.spec.alpha.def_impl(cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_multi_DASH_spec,cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_),cljs.spec.alpha.multi_spec_impl.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,new cljs.core.Var(function(){return hoplon.spec.do_BANG_;},cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$ns,cljs.core.cst$kw$name,cljs.core.cst$kw$file,cljs.core.cst$kw$end_DASH_column,cljs.core.cst$kw$column,cljs.core.cst$kw$line,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$arglists,cljs.core.cst$kw$doc,cljs.core.cst$kw$test],[cljs.core.cst$sym$hoplon$spec,cljs.core.cst$sym$do_BANG_,"/home/ubuntu/.boot/cache/tmp/home/ubuntu/dim-valley/ebq/-xb7kpv/index.html.out/hoplon/spec.cljs",14,1,36,36,cljs.core.List.EMPTY,null,(cljs.core.truth_(hoplon.spec.do_BANG_)?hoplon.spec.do_BANG_.cljs$lang$test:null)])),cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_));
cljs.spec.alpha.def_impl(cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_multi_DASH_spec,cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_),cljs.spec.alpha.multi_spec_impl.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,new cljs.core.Var(function(){return hoplon.spec.on_BANG_;},cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$ns,cljs.core.cst$kw$name,cljs.core.cst$kw$file,cljs.core.cst$kw$end_DASH_column,cljs.core.cst$kw$column,cljs.core.cst$kw$line,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$arglists,cljs.core.cst$kw$doc,cljs.core.cst$kw$test],[cljs.core.cst$sym$hoplon$spec,cljs.core.cst$sym$on_BANG_,"/home/ubuntu/.boot/cache/tmp/home/ubuntu/dim-valley/ebq/-xb7kpv/index.html.out/hoplon/spec.cljs",14,1,44,44,cljs.core.List.EMPTY,null,(cljs.core.truth_(hoplon.spec.on_BANG_)?hoplon.spec.on_BANG_.cljs$lang$test:null)])),cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_));
