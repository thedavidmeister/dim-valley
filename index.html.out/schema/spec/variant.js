...
}catch (e16203){if((e16203 instanceof Object)){
var e_SHARP_ = e16203;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16205,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16205,else__8438__auto__);
...
return (function (){
var G__16208 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__16208) : self__.err_f.call(null,G__16208));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__16210 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__16210) : self__.post.call(null,G__16210));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16204){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16204){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16211 = cljs.core.keyword_identical_QMARK_;
var expr__16212 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16214 = cljs.core.cst$kw$pre;
...
return (new schema.spec.variant.VariantSpec(G__16204,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16216 = cljs.core.cst$kw$options;
...
return (new schema.spec.variant.VariantSpec(self__.pre,G__16204,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16218 = cljs.core.cst$kw$err_DASH_f;
var G__16219 = expr__16212;
return (pred__16211.cljs$core$IFn$_invoke$arity$2 ? pred__16211.cljs$core$IFn$_invoke$arity$2(G__16218,G__16219) : pred__16211.call(null,G__16218,G__16219));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__16204,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16220 = cljs.core.cst$kw$post;
var G__16221 = expr__16212;
return (pred__16211.cljs$core$IFn$_invoke$arity$2 ? pred__16211.cljs$core$IFn$_invoke$arity$2(G__16220,G__16221) : pred__16211.call(null,G__16220,G__16221));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__16204,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16204),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16204){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__16204,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__16206){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16206),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__16206),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__16206),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__16206),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16206,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args16223 = [];
var len__8981__auto___16226 = arguments.length;
var i__8982__auto___16227 = (0);
while(true){
if((i__8982__auto___16227 < len__8981__auto___16226)){
args16223.push((arguments[i__8982__auto___16227]));

var G__16228 = (i__8982__auto___16227 + (1));
i__8982__auto___16227 = G__16228;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args16223.length)].join('')));
