...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21181,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21181,else__8438__auto__);
...
return (function (){
var G__21184 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__21184) : self__.err_f.call(null,G__21184));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__21186 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__21186) : self__.post.call(null,G__21186));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21180){
var self__ = this;
var G__21180__$1 = this;
return (new cljs.core.RecordIter((0),G__21180__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21180){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21187 = cljs.core.keyword_identical_QMARK_;
var expr__21188 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21190 = cljs.core.cst$kw$pre;
...
return (new schema.spec.variant.VariantSpec(G__21180,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21192 = cljs.core.cst$kw$options;
...
return (new schema.spec.variant.VariantSpec(self__.pre,G__21180,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21194 = cljs.core.cst$kw$err_DASH_f;
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__21180,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21196 = cljs.core.cst$kw$post;
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__21180,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21180),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21180){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__21180,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__21182){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21182),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__21182),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__21182),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__21182),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21182,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args21199 = [];
var len__8981__auto___21202 = arguments.length;
var i__8982__auto___21203 = (0);
while(true){
if((i__8982__auto___21203 < len__8981__auto___21202)){
args21199.push((arguments[i__8982__auto___21203]));

var G__21204 = (i__8982__auto___21203 + (1));
i__8982__auto___21203 = G__21204;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args21199.length)].join('')));
