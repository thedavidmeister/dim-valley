...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16131,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16133 = (((k16131 instanceof cljs.core.Keyword))?k16131.fqn:null);
switch (G__16133) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16131,else__8438__auto__);
...
return (function (){
var G__16134 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__16134) : self__.err_f.call(null,G__16134));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__7760__auto____$1 = (function (){var G__16136 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__16136) : self__.post.call(null,G__16136));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16130){
var self__ = this;
var G__16130__$1 = this;
return (new cljs.core.RecordIter((0),G__16130__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16130){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16137 = cljs.core.keyword_identical_QMARK_;
var expr__16138 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16140 = cljs.core.cst$kw$pre;
var G__16141 = expr__16138;
return (pred__16137.cljs$core$IFn$_invoke$arity$2 ? pred__16137.cljs$core$IFn$_invoke$arity$2(G__16140,G__16141) : pred__16137.call(null,G__16140,G__16141));
})())){
return (new schema.spec.variant.VariantSpec(G__16130,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16142 = cljs.core.cst$kw$options;
var G__16143 = expr__16138;
return (pred__16137.cljs$core$IFn$_invoke$arity$2 ? pred__16137.cljs$core$IFn$_invoke$arity$2(G__16142,G__16143) : pred__16137.call(null,G__16142,G__16143));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,G__16130,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16144 = cljs.core.cst$kw$err_DASH_f;
var G__16145 = expr__16138;
return (pred__16137.cljs$core$IFn$_invoke$arity$2 ? pred__16137.cljs$core$IFn$_invoke$arity$2(G__16144,G__16145) : pred__16137.call(null,G__16144,G__16145));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__16130,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16146 = cljs.core.cst$kw$post;
var G__16147 = expr__16138;
return (pred__16137.cljs$core$IFn$_invoke$arity$2 ? pred__16137.cljs$core$IFn$_invoke$arity$2(G__16146,G__16147) : pred__16137.call(null,G__16146,G__16147));
})())){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__16130,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16130),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16130){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__16130,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__16132){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16132),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__16132),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__16132),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__16132),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16132,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
var args16149 = [];
var len__8981__auto___16152 = arguments.length;
var i__8982__auto___16153 = (0);
while(true){
if((i__8982__auto___16153 < len__8981__auto___16152)){
args16149.push((arguments[i__8982__auto___16153]));

var G__16154 = (i__8982__auto___16153 + (1));
i__8982__auto___16153 = G__16154;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args16149.length)].join('')));
