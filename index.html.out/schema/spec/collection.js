...
var G__16087 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__16087) {
case "schema.spec.collection/optional":
var G__16088 = cljs.core.next(e);
var G__16089 = params;
var G__16090 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__16088,G__16089,G__16090) : schema.spec.collection.sequence_transformer.call(null,G__16088,G__16089,G__16090));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(e))].join('')));
...
return (function (res,x){
var G__16091 = res;
var G__16092 = (function (){var G__16093 = ((function (G__16091,parser,c){
return (function (t){
...
;
var G__16094 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__16093,G__16094) : parser.call(null,G__16093,G__16094));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__16091,G__16092) : then.call(null,G__16091,G__16092));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__16096_SHARP_){
return (cljs.core.vector_QMARK_(p1__16096_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__16096_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
if(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$schema$spec$collection_SLASH_remaining,null,cljs.core.cst$kw$schema$spec$collection_SLASH_optional,null], null), null).call(null,cljs.core.first(elt)))){
} else {
throw (new Error("Assert failed: (#{:schema.spec.collection/remaining :schema.spec.collection/optional} (first elt))"));
}

return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(schema.spec.collection.subschemas,cljs.core.array_seq([cljs.core.next(elt)], 0));
}
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__8435__auto__,k__8436__auto__){
var self__ = this;
var this__8435__auto____$1 = this;
return this__8435__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__8436__auto__,null);
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16098,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16100 = (((k16098 instanceof cljs.core.Keyword))?k16098.fqn:null);
switch (G__16100) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16098,else__8438__auto__);
...
var self__ = this;
var this$__$1 = this;
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(schema.spec.collection.subschemas,cljs.core.array_seq([self__.elements], 0));
});
...
var res = (function (){var G__16101 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16101) : cljs.core.atom.call(null,G__16101));
})();
...
if(cljs.core.truth_((function (){var or__7760__auto____$1 = cljs.core.seq(remaining);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__8449__auto__,writer__8450__auto__,opts__8451__auto__){
var self__ = this;
...
;
return cljs.core.pr_sequential_writer(writer__8450__auto__,pr_pair__8452__auto__,"#schema.spec.collection.CollectionSpec{",", ","}",opts__8451__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$pre,self__.pre],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$constructor,self__.constructor$],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$elements,self__.elements],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$on_DASH_error,self__.on_error],null))], null),self__.__extmap));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$ = cljs.core.PROTOCOL_SENTINEL;

schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16097){
var self__ = this;
var G__16097__$1 = this;
return (new cljs.core.RecordIter((0),G__16097__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__8433__auto__){
var self__ = this;
var this__8433__auto____$1 = this;
return self__.__meta;
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__8429__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__8439__auto__){
var self__ = this;
var this__8439__auto____$1 = this;
return (4 + cljs.core.count(self__.__extmap));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__8430__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__8431__auto__,other__8432__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__8444__auto__,k__8445__auto__){
var self__ = this;
var this__8444__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$pre,null,cljs.core.cst$kw$elements,null,cljs.core.cst$kw$constructor,null,cljs.core.cst$kw$on_DASH_error,null], null), null),k__8445__auto__)){
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__8445__auto__)),null));
}
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16097){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16102 = cljs.core.keyword_identical_QMARK_;
var expr__16103 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16105 = cljs.core.cst$kw$pre;
var G__16106 = expr__16103;
return (pred__16102.cljs$core$IFn$_invoke$arity$2 ? pred__16102.cljs$core$IFn$_invoke$arity$2(G__16105,G__16106) : pred__16102.call(null,G__16105,G__16106));
})())){
return (new schema.spec.collection.CollectionSpec(G__16097,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16107 = cljs.core.cst$kw$constructor;
var G__16108 = expr__16103;
return (pred__16102.cljs$core$IFn$_invoke$arity$2 ? pred__16102.cljs$core$IFn$_invoke$arity$2(G__16107,G__16108) : pred__16102.call(null,G__16107,G__16108));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__16097,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16109 = cljs.core.cst$kw$elements;
var G__16110 = expr__16103;
return (pred__16102.cljs$core$IFn$_invoke$arity$2 ? pred__16102.cljs$core$IFn$_invoke$arity$2(G__16109,G__16110) : pred__16102.call(null,G__16109,G__16110));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__16097,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16111 = cljs.core.cst$kw$on_DASH_error;
var G__16112 = expr__16103;
return (pred__16102.cljs$core$IFn$_invoke$arity$2 ? pred__16102.cljs$core$IFn$_invoke$arity$2(G__16111,G__16112) : pred__16102.call(null,G__16111,G__16112));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__16097,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16097),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__8447__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16097){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__16097,self__.__extmap,self__.__hash));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__8440__auto__,entry__8441__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.cljs$lang$ctorPrSeq = (function (this__8471__auto__){
return cljs.core._conj(cljs.core.List.EMPTY,"schema.spec.collection/CollectionSpec");
});

schema.spec.collection.CollectionSpec.cljs$lang$ctorPrWriter = (function (this__8471__auto__,writer__8472__auto__){
return cljs.core._write(writer__8472__auto__,"schema.spec.collection/CollectionSpec");
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__16099){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16099),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__16099),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__16099),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__16099),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16099,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___16115 = arguments.length;
var i__8982__auto___16116 = (0);
while(true){
if((i__8982__auto___16116 < len__8981__auto___16115)){
args__8988__auto__.push((arguments[i__8982__auto___16116]));

var G__16117 = (i__8982__auto___16116 + (1));
i__8982__auto___16116 = G__16117;
continue;
} else {
}
break;
...
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(argseq__8989__auto__);
});
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq16114){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16114));
});
...
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([base], 0));
}
});
schema.spec.collection.optional_tail = (function schema$spec$collection$optional_tail(schema__$1,parser,more){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$schema,schema__$1,cljs.core.cst$kw$parser,parser], null)], 0)),more);
});
