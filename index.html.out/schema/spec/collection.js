...
var G__16459 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__16459) {
case "schema.spec.collection/optional":
var G__16460 = cljs.core.next(e);
var G__16461 = params;
var G__16462 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__16460,G__16461,G__16462) : schema.spec.collection.sequence_transformer.call(null,G__16460,G__16461,G__16462));
...
return (function (res,x){
var G__16463 = res;
var G__16464 = (function (){var G__16465 = ((function (G__16463,parser,c){
return (function (t){
...
;
var G__16466 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__16465,G__16466) : parser.call(null,G__16465,G__16466));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__16463,G__16464) : then.call(null,G__16463,G__16464));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__16468_SHARP_){
return (cljs.core.vector_QMARK_(p1__16468_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__16468_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16470,else__8438__auto__){
var self__ = this;
...
var res = (function (){var G__16473 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16473) : cljs.core.atom.call(null,G__16473));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16469){
var self__ = this;
var G__16469__$1 = this;
return (new cljs.core.RecordIter((0),G__16469__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16469){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16474 = cljs.core.keyword_identical_QMARK_;
var expr__16475 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16477 = cljs.core.cst$kw$pre;
var G__16478 = expr__16475;
return (pred__16474.cljs$core$IFn$_invoke$arity$2 ? pred__16474.cljs$core$IFn$_invoke$arity$2(G__16477,G__16478) : pred__16474.call(null,G__16477,G__16478));
})())){
return (new schema.spec.collection.CollectionSpec(G__16469,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16479 = cljs.core.cst$kw$constructor;
var G__16480 = expr__16475;
return (pred__16474.cljs$core$IFn$_invoke$arity$2 ? pred__16474.cljs$core$IFn$_invoke$arity$2(G__16479,G__16480) : pred__16474.call(null,G__16479,G__16480));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__16469,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16481 = cljs.core.cst$kw$elements;
var G__16482 = expr__16475;
return (pred__16474.cljs$core$IFn$_invoke$arity$2 ? pred__16474.cljs$core$IFn$_invoke$arity$2(G__16481,G__16482) : pred__16474.call(null,G__16481,G__16482));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__16469,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16483 = cljs.core.cst$kw$on_DASH_error;
var G__16484 = expr__16475;
return (pred__16474.cljs$core$IFn$_invoke$arity$2 ? pred__16474.cljs$core$IFn$_invoke$arity$2(G__16483,G__16484) : pred__16474.call(null,G__16483,G__16484));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__16469,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16469),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16469){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__16469,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__16471){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16471),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__16471),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__16471),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__16471),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16471,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq16486){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16486));
});
