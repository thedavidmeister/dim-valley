...
var G__21332 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__21332) {
case "schema.spec.collection/optional":
var G__21333 = cljs.core.next(e);
var G__21334 = params;
var G__21335 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__21333,G__21334,G__21335) : schema.spec.collection.sequence_transformer.call(null,G__21333,G__21334,G__21335));
...
return (function (res,x){
var G__21336 = res;
var G__21337 = (function (){var G__21338 = ((function (G__21336,parser,c){
return (function (t){
...
;
var G__21339 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__21338,G__21339) : parser.call(null,G__21338,G__21339));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__21336,G__21337) : then.call(null,G__21336,G__21337));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__21341_SHARP_){
return (cljs.core.vector_QMARK_(p1__21341_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__21341_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21343,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__21345 = (((k21343 instanceof cljs.core.Keyword))?k21343.fqn:null);
switch (G__21345) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21343,else__8438__auto__);
...
var res = (function (){var G__21346 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__21346) : cljs.core.atom.call(null,G__21346));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21342){
var self__ = this;
var G__21342__$1 = this;
return (new cljs.core.RecordIter((0),G__21342__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21342){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21347 = cljs.core.keyword_identical_QMARK_;
var expr__21348 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21350 = cljs.core.cst$kw$pre;
...
return (new schema.spec.collection.CollectionSpec(G__21342,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21352 = cljs.core.cst$kw$constructor;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,G__21342,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21354 = cljs.core.cst$kw$elements;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__21342,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21356 = cljs.core.cst$kw$on_DASH_error;
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__21342,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21342),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21342){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__21342,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__21344){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21344),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__21344),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__21344),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__21344),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21344,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq21359){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21359));
});
