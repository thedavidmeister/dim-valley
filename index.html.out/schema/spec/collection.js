...
var G__14614 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__14614) {
case "schema.spec.collection/optional":
var G__14615 = cljs.core.next(e);
var G__14616 = params;
var G__14617 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__14615,G__14616,G__14617) : schema.spec.collection.sequence_transformer.call(null,G__14615,G__14616,G__14617));
...
return (function (res,x){
var G__14618 = res;
var G__14619 = (function (){var G__14620 = ((function (G__14618,parser,c){
return (function (t){
...
;
var G__14621 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__14620,G__14621) : parser.call(null,G__14620,G__14621));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__14618,G__14619) : then.call(null,G__14618,G__14619));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__14623_SHARP_){
return (cljs.core.vector_QMARK_(p1__14623_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__14623_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k14625,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k14625,else__8438__auto__);
...
var res = (function (){var G__14628 = cljs.core.PersistentVector.EMPTY;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__14624){
var self__ = this;
var G__14624__$1 = this;
return (new cljs.core.RecordIter((0),G__14624__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__14624){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__14629 = cljs.core.keyword_identical_QMARK_;
var expr__14630 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__14632 = cljs.core.cst$kw$pre;
var G__14633 = expr__14630;
return (pred__14629.cljs$core$IFn$_invoke$arity$2 ? pred__14629.cljs$core$IFn$_invoke$arity$2(G__14632,G__14633) : pred__14629.call(null,G__14632,G__14633));
})())){
return (new schema.spec.collection.CollectionSpec(G__14624,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__14634 = cljs.core.cst$kw$constructor;
var G__14635 = expr__14630;
return (pred__14629.cljs$core$IFn$_invoke$arity$2 ? pred__14629.cljs$core$IFn$_invoke$arity$2(G__14634,G__14635) : pred__14629.call(null,G__14634,G__14635));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__14624,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__14636 = cljs.core.cst$kw$elements;
var G__14637 = expr__14630;
return (pred__14629.cljs$core$IFn$_invoke$arity$2 ? pred__14629.cljs$core$IFn$_invoke$arity$2(G__14636,G__14637) : pred__14629.call(null,G__14636,G__14637));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__14624,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__14638 = cljs.core.cst$kw$on_DASH_error;
var G__14639 = expr__14630;
return (pred__14629.cljs$core$IFn$_invoke$arity$2 ? pred__14629.cljs$core$IFn$_invoke$arity$2(G__14638,G__14639) : pred__14629.call(null,G__14638,G__14639));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__14624,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__14624),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__14624){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__14624,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__14626){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__14626),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__14626),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__14626),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__14626),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__14626,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___14642 = arguments.length;
var i__8982__auto___14643 = (0);
while(true){
if((i__8982__auto___14643 < len__8981__auto___14642)){
args__8988__auto__.push((arguments[i__8982__auto___14643]));

var G__14644 = (i__8982__auto___14643 + (1));
i__8982__auto___14643 = G__14644;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq14641){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14641));
});
