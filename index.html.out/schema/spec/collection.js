...
var G__21145 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__21145) {
case "schema.spec.collection/optional":
var G__21146 = cljs.core.next(e);
var G__21147 = params;
var G__21148 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__21146,G__21147,G__21148) : schema.spec.collection.sequence_transformer.call(null,G__21146,G__21147,G__21148));
...
return (function (res,x){
var G__21149 = res;
var G__21150 = (function (){var G__21151 = ((function (G__21149,parser,c){
return (function (t){
...
;
var G__21152 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__21151,G__21152) : parser.call(null,G__21151,G__21152));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__21149,G__21150) : then.call(null,G__21149,G__21150));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__21154_SHARP_){
return (cljs.core.vector_QMARK_(p1__21154_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__21154_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k21156,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21156,else__8438__auto__);
...
var res = (function (){var G__21159 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__21159) : cljs.core.atom.call(null,G__21159));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21155){
var self__ = this;
var G__21155__$1 = this;
return (new cljs.core.RecordIter((0),G__21155__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__21155){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__21160 = cljs.core.keyword_identical_QMARK_;
var expr__21161 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__21163 = cljs.core.cst$kw$pre;
var G__21164 = expr__21161;
return (pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(G__21163,G__21164) : pred__21160.call(null,G__21163,G__21164));
})())){
return (new schema.spec.collection.CollectionSpec(G__21155,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21165 = cljs.core.cst$kw$constructor;
var G__21166 = expr__21161;
return (pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(G__21165,G__21166) : pred__21160.call(null,G__21165,G__21166));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__21155,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21167 = cljs.core.cst$kw$elements;
var G__21168 = expr__21161;
return (pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(G__21167,G__21168) : pred__21160.call(null,G__21167,G__21168));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__21155,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__21169 = cljs.core.cst$kw$on_DASH_error;
var G__21170 = expr__21161;
return (pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(G__21169,G__21170) : pred__21160.call(null,G__21169,G__21170));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__21155,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__21155),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__21155){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__21155,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__21157){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21157),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__21157),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__21157),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__21157),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21157,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___21173 = arguments.length;
var i__8982__auto___21174 = (0);
while(true){
if((i__8982__auto___21174 < len__8981__auto___21173)){
args__8988__auto__.push((arguments[i__8982__auto___21174]));

var G__21175 = (i__8982__auto___21174 + (1));
i__8982__auto___21174 = G__21175;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq21172){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21172));
});
