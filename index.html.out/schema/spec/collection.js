...
var G__16053 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__16053) {
case "schema.spec.collection/optional":
var G__16054 = cljs.core.next(e);
var G__16055 = params;
var G__16056 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__16054,G__16055,G__16056) : schema.spec.collection.sequence_transformer.call(null,G__16054,G__16055,G__16056));
...
return (function (res,x){
var G__16057 = res;
var G__16058 = (function (){var G__16059 = ((function (G__16057,parser,c){
return (function (t){
...
;
var G__16060 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__16059,G__16060) : parser.call(null,G__16059,G__16060));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__16057,G__16058) : then.call(null,G__16057,G__16058));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__16062_SHARP_){
return (cljs.core.vector_QMARK_(p1__16062_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__16062_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16064,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__16066 = (((k16064 instanceof cljs.core.Keyword))?k16064.fqn:null);
switch (G__16066) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16064,else__8438__auto__);
...
var res = (function (){var G__16067 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16067) : cljs.core.atom.call(null,G__16067));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16063){
var self__ = this;
var G__16063__$1 = this;
return (new cljs.core.RecordIter((0),G__16063__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16063){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16068 = cljs.core.keyword_identical_QMARK_;
var expr__16069 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16071 = cljs.core.cst$kw$pre;
var G__16072 = expr__16069;
return (pred__16068.cljs$core$IFn$_invoke$arity$2 ? pred__16068.cljs$core$IFn$_invoke$arity$2(G__16071,G__16072) : pred__16068.call(null,G__16071,G__16072));
})())){
return (new schema.spec.collection.CollectionSpec(G__16063,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16073 = cljs.core.cst$kw$constructor;
var G__16074 = expr__16069;
return (pred__16068.cljs$core$IFn$_invoke$arity$2 ? pred__16068.cljs$core$IFn$_invoke$arity$2(G__16073,G__16074) : pred__16068.call(null,G__16073,G__16074));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__16063,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16075 = cljs.core.cst$kw$elements;
var G__16076 = expr__16069;
return (pred__16068.cljs$core$IFn$_invoke$arity$2 ? pred__16068.cljs$core$IFn$_invoke$arity$2(G__16075,G__16076) : pred__16068.call(null,G__16075,G__16076));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__16063,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__16077 = cljs.core.cst$kw$on_DASH_error;
var G__16078 = expr__16069;
return (pred__16068.cljs$core$IFn$_invoke$arity$2 ? pred__16068.cljs$core$IFn$_invoke$arity$2(G__16077,G__16078) : pred__16068.call(null,G__16077,G__16078));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__16063,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16063),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16063){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__16063,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__16065){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16065),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__16065),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__16065),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__16065),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16065,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___16081 = arguments.length;
var i__8982__auto___16082 = (0);
while(true){
if((i__8982__auto___16082 < len__8981__auto___16081)){
args__8988__auto__.push((arguments[i__8982__auto___16082]));

var G__16083 = (i__8982__auto___16082 + (1));
i__8982__auto___16082 = G__16083;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq16080){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16080));
});
